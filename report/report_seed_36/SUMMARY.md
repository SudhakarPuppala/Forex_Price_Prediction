...
|---|---|---|---|---|---|
| Hybrid_CNN_LSTM_Transformer | 0.02229 | 0.03063 | 1102.7 | 0.5252 | 0.5343 |
...
- Hybrid_CNN_LSTM_Transformer's directional accuracy (0.5252) is close to the 0.5 random-guess baseline — treat any directional edge from this run as inconclusive rather than a confirmed skill.
